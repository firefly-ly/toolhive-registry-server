  ...
  clients: [
    {
      ...
      redirect_uris: [
        ...
        // HTTPS variants (dev server run with --experimental-https)
        "https://localhost:3000/api/auth/oauth2/callback/oidc",
        "https://localhost:3000/api/auth/oauth2/callback/okta",
      ],
