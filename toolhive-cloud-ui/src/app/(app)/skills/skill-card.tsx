...
interface SkillCardProps {
  ...
  /** 同 group 的完整卡片数据（含激活版 skill 与其已上架版本）。长度>1 时标题右显示版本下拉可就地切换。 */
  siblingCards?: Skill[];
}
 ...
 */
export function SkillCard({ skill, favorited, onClick, siblingCards }: SkillCardProps) {
  const versions = siblingCards && siblingCards.length > 1 ? siblingCards : [skill];
